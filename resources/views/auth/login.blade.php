...
@section('title', 'Login - NotifySmartLink')
...
<div style="max-width: 400px; margin: 2rem auto; background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    <div style="text-align: center; margin-bottom: 2rem;">
        ...
        <p style="color: #64748b;">Sign in to NotifySmartLink</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div style="margin-bottom: 1rem;">
            ...
            <input type="email" name="email" style="width: 100%; padding: 0.75rem; border: 2px solid #e5e7eb; border-radius: 8px; font-size: 1rem;" placeholder="Enter your email" required value="{{ old('email') }}">
        </div>

        <div style="margin-bottom: 1.5rem;">
            <label style="display: block; font-weight: 600; margin-bottom: 0.5rem;">Password</label>
            <input type="password" name="password" style="width: 100%; padding: 0.75rem; border: 2px solid #e5e7eb; border-radius: 8px; font-size: 1rem;" placeholder="Enter your password" required>
        </div>
